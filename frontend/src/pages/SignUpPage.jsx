                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="form-control">
                            ...
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-evnets-none">
                                ...
                                <button
                                    type="button"
                                    className="absolute inset-y-0 right-0 pr-3 flex items-container"
                                    onClick={() => setShowPassword(!showPassword)}
                                >
                                    {showPassword ? (
                                        <EyeOff className="size-5 text-base-container/40"/>
                                    ) : (
